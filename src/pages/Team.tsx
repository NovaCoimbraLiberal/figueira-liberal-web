...
const Team = () => {
  ...
  const municipalCandidates = [
    ...
    },
    {
      name: "Paulo Sousa",
      role: "Candidato #4",
      description: "Licenciado em Comunicação Organizacional e exerce atualmente funções na área comercial, no setor das tintas.  Vice Coordenador da IL FF e membro fundador",
